...
const chips = [
  { label: "Add CI/CD to my existing project", path: "/flow/add-cicd" },
  { label: "Create a Docker Compose for my services", path: "/flow/docker-compose" },
  { label: "Build infra for a new project", path: "/flow/new-project" },
  { label: "Not sure? Tell us about your project", path: "/flow/freeform" },
];
